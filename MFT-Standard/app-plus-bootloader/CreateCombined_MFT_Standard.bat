...
SET APP_OUT="..\IAR ARM - Default\MFT-Standard.out"
SET APP_SREC="app.srec"
SET STACK_SREC="stack.srec"
SET SIGNED_STACK="MFT-Standard-stack-signed.s37"
SET SIGNED_APP="MFT-Standard-app-signed.s37"
SET BL_STACK_APP="MFT-Standard.s37"

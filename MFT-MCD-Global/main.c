...
#define FIRMWARE_VER			"4.02"	// Must be 4 characters
...
#else
#define HARDWARE_VER			"010"	// Must be 3 characters
...
void SetOffset(int32 TEVolts, uint8* TCReading, int32* Offset, uint8 * stateMachine)
{
	...
	work *= 968615;
	work /= 100000;
	work += 5;  									// Round up (ambient operating range is >= 32degF, so we never need to round down)
	work /= 10;										// work is now A2D counts of CJC; (approx. 968 @ 77degF)
...
void SetGain(int32 TEVolts, uint8* TCReading, int32* Gain, int32 Offset, uint8 MeasurementInterval, uint8 * stateMachine)
{
	...
	// Convert TEVolts to A2D counts..
	work = TEVolts;															// work is approx. 964uV @ 75.5degF..
	work *= 968615;
	work /= 100000;
	work += 5; 																// Round up (ambient operating range is >= 32degF, so we never need to round down)
	work /= 10;																// work is now A2D counts of CJC; (approx. 968 @ 77degF)

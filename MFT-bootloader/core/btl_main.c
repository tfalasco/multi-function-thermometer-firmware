...
void SystemInit2(void)
{
  ...
  // Set GPIO pins to turn on LED indicator.
  CMU_ClockEnable(cmuClock_GPIO, true);
  GPIO_PinModeSet(gpioPortD, 12, gpioModePushPull, 0);	// Red
  GPIO_PinModeSet(gpioPortD, 13, gpioModePushPull, 0);	// Blue
  GPIO_PinModeSet(gpioPortD, 14, gpioModePushPull, 1);	// Green
  GPIO_PinModeSet(gpioPortA, 5, gpioModePushPull, 1);
//  GPIO_PortOutSetVal(gpioPortD, 0x0000, 0x2000);
//  GPIO_PortOutSetVal(gpioPortA, 0x0020, 0x0020);

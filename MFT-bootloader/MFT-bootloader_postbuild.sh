...
echo " "
"${COMMANDER}" convert "C:\SiliconLabs\SimplicityStudio\v4\developer\sdks\gecko_sdk_suite\v1.1/platform/bootloader/build/first_stage/gcc/first_stage_btl_efr32xg1.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
